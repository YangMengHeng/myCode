public class StringExample {
	public static void main(String args[]) {
        ...
        int temp = path.indexOf("A.java");
		String fileName = path.substring(temp, temp + 6);// 获取path中“A.java”子字符串
		...
		String s8 = String.valueOf(m); // String调用valuOf(double n)方法将m转化为字符串对象
		position = s8.indexOf(".");
		String temp1 = s8.substring(position + 1); // 获取s8中小数点后面的小数
		System.out.println("数字" + m + "有" + temp1.length() + "位小数");
